                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton.icon(
                                      onPressed: () {
                                        // Action for reserving service
                                       reserveService(context, service);
                                      },
...
void reserveService(BuildContext context, Service service) {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => Reservation(category: service.category ?? 'Unknown'),
    ),
  );
}
}
      ...
      bottomNavigationBar: Padding(
        ...
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              reserveService(context, service);
              print('Reserver maintenant clicked');
            },
            child: Text(
              'Reserver maintenant',
              style: TextStyle(fontSize: 18,color: Colors.white), // Adjust text size
            ),
          ),
        ),
      ),
